...
<body>
    ...
    <section class="bg-green-500">
        <div class="p-8">
            ...
            <div class="mb-2">
                <p><strong>Direccion: </strong> {{$contacto['empresa']}}</p>
            </div>
            <div class="mb-2">
                <p><strong>Telefono: </strong>{{$contacto['celular']}}</p>
            </div>
            <div class="mb-2">
        ...
        <div class="mt-4 text-white font-bold text-center">
            <small class="text-green-900">© {{ date('Y') }} Allma. Todos los derechos reservados.</small>
        </div>
    </section>
</body>
